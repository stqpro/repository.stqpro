...
from lib.Crypto.Util.py3compat import byte_string, b, bchr, bord

from lib.Crypto.Util.number import long_to_bytes, bytes_to_long
...
class DerInteger(DerObject):
        ...
        An example of encoding is::
          ...
          >>> from lib.Crypto.Util.asn1 import DerInteger
...
class DerSequence(DerObject):
        ...
        An example of encoding is:
          ...
          >>> from lib.Crypto.Util.asn1 import DerSequence, DerInteger
          >>> from binascii import hexlify, unhexlify
...
class DerOctetString(DerObject):
    ...
    >>> from lib.Crypto.Util.asn1 import DerOctetString
    >>> from binascii import hexlify, unhexlify
...
class DerObjectId(DerObject):
    ...
    >>> from lib.Crypto.Util.asn1 import DerObjectId
    >>> from binascii import hexlify, unhexlify
...
class DerBitString(DerObject):
    ...
    >>> from lib.Crypto.Util.asn1 import DerBitString
    >>> from binascii import hexlify, unhexlify
