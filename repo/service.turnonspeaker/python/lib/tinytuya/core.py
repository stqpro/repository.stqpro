...
#     from lib.Crypto.Cipher import AES  # PyCrypto
# except ImportError:
#     Crypto = AES = None
#     from lib import pyaes  # https://github.com/ricmoo/pyaes
...
def set_debug(toggle=True, color=False):
...
def scan(maxretry=None, color=False, forcescan=False):
...
# Scan function
def deviceScan(verbose=False, maxretry=None, color=False, poll=True, forcescan=False, byID=False):
